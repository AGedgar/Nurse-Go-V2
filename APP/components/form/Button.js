...
export class Button extends React.Component{
    ...
    getIcon(){
        if(this.props.icon != undefined){
            ...
            }else if(this.props.icon == "zoomOut"){
                return (
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    render(){
        return (
            <div>
                <div className={'button '+(this.props.style=="purple"?"purple": (this.props.style=="white" ? "white" : "green"))+' '+(this.props.shape=="circular"?"circular": "")} onClick={this.props.onClick}>
                    {this.getIcon()}
                    {this.props.children}
                </div>
                <style jsx>{`
